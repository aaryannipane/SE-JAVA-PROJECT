...
public class AllRecords extends javax.swing.JFrame {
    ...
    public AllRecords() {
        initComponents();
        this.setTitle("View All Records");
    ...
    public void setRecordsToTable(){
        try{
            ...
            while(rs.next()){
                ...
                Object[] obj = {recieptNo, rollNo, studentName, courseName, paymentMode, amount, remark, date};
    ...
    private void initComponents() {
        ...
        tbl_allRecords.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        tbl_allRecords.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Reciept No", "Roll No", "Student Name", "Course Name", "Payment Mode", "Total Amount", "Remark", "Date"
            }
        ));
        tbl_allRecords.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tbl_allRecords);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, 810, 530));
