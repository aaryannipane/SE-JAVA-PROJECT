...
public class EditCourse extends javax.swing.JFrame {
    ...
    public void setRecordsToTable(){
        try{
            ...
            while(rs.next()){
                ...
                Object[] obj = {id, courseName, cost};
                model = (DefaultTableModel)tbl_courseTable.getModel();
                model.addRow(obj);
            }
        }
        catch(Exception e){
    ...
    public void clearTable(){
        DefaultTableModel model = (DefaultTableModel)tbl_courseTable.getModel();
        model.setRowCount(0);
    }
    ...
    private void initComponents() {
        ...
        tbl_courseTable = new javax.swing.JTable();
        ...
        tbl_courseTable.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        tbl_courseTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbl_courseTable.getTableHeader().setReorderingAllowed(false);
        tbl_courseTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_courseTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbl_courseTable);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 140, 540, 460));
        jPanel1.add(txt_coursePrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 300, 190, 30));
        jPanel1.add(txt_courseId, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, 190, 30));
        jPanel1.add(txt_courseName, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 190, 30));

        jLabel2.setFont(new java.awt.Font("SansSerif", 0, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("* Course Price :");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 270, 160, 30));

        jLabel8.setFont(new java.awt.Font("SansSerif", 0, 15)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("* Course id :");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 160, 30));

        jLabel9.setFont(new java.awt.Font("SansSerif", 0, 15)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("* Course Name :");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, 160, 30));

        btn_delete.setBackground(new java.awt.Color(209, 26, 42));
        ...
        jPanel1.add(btn_delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 370, -1, -1));

        btn_update.setBackground(new java.awt.Color(3, 218, 197));
        ...
        jPanel1.add(btn_update, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 370, -1, -1));

        btn_insert.setBackground(new java.awt.Color(3, 218, 197));
        btn_insert.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        ...
        jPanel1.add(btn_insert, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, -1, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 30)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setText("Edit Course");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 890, -1));
    ...
    private void tbl_courseTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_courseTableMouseClicked
        // TODO add your handling code here:
        int rowNo = tbl_courseTable.getSelectedRow();
        TableModel model = tbl_courseTable.getModel();
    ...
    }//GEN-LAST:event_tbl_courseTableMouseClicked
    ...
    private javax.swing.JTable tbl_courseTable;
