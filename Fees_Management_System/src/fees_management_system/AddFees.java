...
//    }
    ...
    public boolean validation(){
        ...
        if(txt_totalCourseAmount.getText().equals("") || txt_totalCourseAmount.getText().matches("[0-9]+") == false){
...
//        taking value and storing in variables
        ...
        try{
            ...
            pst.setString(15, totalAmountWords);
    ...
    private void initComponents() {
        ...
        txt_totalAmountWords.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        txt_totalAmountWords.setFocusable(false);
        ...
        txt_totalAmount.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        txt_totalAmount.setFocusable(false);
        ...
        txt_totalCourseAmount.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
                txt_totalCourseAmountCaretPositionChanged(evt);
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                txt_totalCourseAmountInputMethodTextChanged(evt);
            }
        });
        ...
        txt_cgstAmount.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        txt_cgstAmount.setFocusable(false);
        ...
        txt_sgstAmount.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        txt_sgstAmount.setFocusable(false);
        ...
        txt_course.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        txt_course.setFocusable(false);
        ...
        txt_recieptNo.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        txt_recieptNo.setFocusable(false);
...
//        txt_totalAmountWords.setText(NumberToWordsConverter.convert((int)total) + " Only");
    ...
    private void txt_totalCourseAmountCaretPositionChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_txt_totalCourseAmountCaretPositionChanged
        // TODO add your handling code here:    
    }//GEN-LAST:event_txt_totalCourseAmountCaretPositionChanged

    private void txt_totalCourseAmountInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_txt_totalCourseAmountInputMethodTextChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_totalCourseAmountInputMethodTextChanged
